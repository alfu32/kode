...
- **Panels**: Files (tree + open callback), Git/Settings placeholders ready for expansion. File tree and Git panels auto-refresh periodically (~5s) without blocking the render loop, keeping status/commits and directory listings up to date.
