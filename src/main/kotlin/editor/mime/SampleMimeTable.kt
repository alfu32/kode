...
object SampleMimeTable {
    ...
    val entries: List<Entry> = listOf(
        ...
        Entry(language="c",extension=".h",mime="text/c",mimeTypeCategory=MimeTypeCategory.TEXT),
        Entry(language="cpp",extension=".hh",mime="text/cpp",mimeTypeCategory=MimeTypeCategory.TEXT),
        Entry(language="cpp",extension=".hpp",mime="text/cpp",mimeTypeCategory=MimeTypeCategory.TEXT),
        Entry(language="cpp",extension=".hxx",mime="text/cpp",mimeTypeCategory=MimeTypeCategory.TEXT),
